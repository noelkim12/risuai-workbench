...
const ROADMAP_TOOLS: readonly RoadmapToolDefinition[] = [
  ...
  {
    description: 'List packaged authoring skills with user-friendly names, descriptions, usage hints, and resource links.',
    mutates: false,
    name: 'workbench.list_authoring_skills',
    phase: 'phase-1',
    phaseDescription: 'Authoring skill recommendation workflow',
  ...
  },
  {
    ...
    phase: 'phase-1',
    phaseDescription: 'Authoring skill recommendation workflow',
    title: 'Recommend authoring skills',
  },
  {
    description: 'Apply an approved authoring skill by returning a plan document preview bundle without writing files.',
    mutates: false,
    name: 'workbench.apply_skill',
    phase: 'phase-1',
    phaseDescription: 'Authoring skill recommendation workflow',
  ...
  },
  {
    ...
    mutates: false,
    name: 'workbench.query_risulua_api',
    phase: 'phase-4',
    phaseDescription: 'Phase 4 analyze / impact expansion',
  ...
  {
    description: 'Create the minimal generated wiki root files when they are missing, without touching manual wiki pages or source artifacts.',
    mutates: true,
    name: 'workbench.ensure_wiki_root',
    phase: 'phase-5',
    phaseDescription: 'Phase 5 advanced mutation',
...
const RESOURCES: readonly WorkbenchResourceRegistryEntry[] = [
  ...
  {
    description: 'Read RisuLua lifecycle, access tier, async, category, function detail, pattern, and pitfall reference resources.',
    name: 'workbench.resource.risulua_reference',
    readOnly: true,
    title: 'RisuLua host function reference resource',
    uriTemplate: 'risuai-workbench://risulua/{risuluaPath}',
  },
  {
    description: 'Read authoring skill catalog and full Markdown skill guidance resources.',
    name: 'workbench.resource.authoring_skills',
    readOnly: true,
    title: 'Authoring skills resource',
