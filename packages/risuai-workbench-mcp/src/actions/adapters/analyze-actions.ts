...
export function registerAnalyzeActions(registry: ActionRegistry): void {
  ...
  registry.register({
    ...
    aliases: ['variable state', 'state ownership'],
    searchText: 'persistent scene derived state store read write lifecycle',
    capability: 'analyze',
    risk: 'read_only',
  ...
  registry.register({
    ...
    aliases: ['relationship state', 'relationship graph'],
    searchText: 'affection attachment trust dependency bond persistent scene state',
    capability: 'analyze',
    risk: 'read_only',
  ...
  registry.register({
    ...
    aliases: ['lorebook injection', 'prompt lifecycle', 'hidden prompt'],
    searchText: 'editInput editRequest editOutput editDisplay editprocess system instruction model prompt storage display',
    capability: 'analyze',
    risk: 'read_only',
