...
const fixtureCorpusSeeds: readonly FixtureCorpusSeed[] = [
  ...
  {
    id: 'lua-basic',
    label: 'Representative lua string-literal fragment',
    kind: 'representative',
    artifact: 'lua',
    cbsBearing: true,
    sourceKind: 'inline-document',
    relativePath: 'happy-script.risulua',
    expectedSections: ['lua-string:1'],
    features: ['happy-path', 'string-literal-fragment'],
  ...
  },
  {
    ...
    expectedSections: ['lua-string:1'],
    expectedDiagnosticCodes: [DiagnosticCode.UnclosedMacro],
    features: ['malformed', 'taxonomy', 'string-literal-fragment'],
    text: 'local userName = "{{user"\nprint(userName)',
  },
];
