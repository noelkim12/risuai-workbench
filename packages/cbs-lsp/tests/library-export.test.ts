...
describe('diagnostics library export', () => {
  it('exports DiagnosticsEngine from the analyzer/diagnostics subpath', async () => {
    const { DiagnosticsEngine } = await import('@risuai-workbench/cbs-language-server/analyzer/diagnostics');
  ...
  it('exports createDiagnosticInfo and DiagnosticCode from the subpath', async () => {
    const { createDiagnosticInfo, DiagnosticCode } = await import('@risuai-workbench/cbs-language-server/analyzer/diagnostics');
