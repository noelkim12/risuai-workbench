...
const PRIVATE_MODULE_TABLE_FIXTURE_ROOT = path.join(
  resolveFixtureRepositoryRoot(),
  'test_suites',
  'extraction_targets',
  'module-table-sample-c',
);
...
describe('risulua-split module-table fixture matrix', () => {
  ...
  it('asserts Private module-table sample domain-candidates have generationStatus generated with explicit grouping evidence', () => {
