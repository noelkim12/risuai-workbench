/**
 * 모듈 lorebook artifact 추출 phase와 변환 헬퍼.
 * @file packages/core/src/cli/extract/module/phases/lorebooks.ts
 */
...
import { ensureDir, writeText, executeLorebookPlan } from '@/node';
...
function entryToCanonicalContent(entry: any): LorebookContent {
